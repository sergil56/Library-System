      ...
      <main class="content px-3 py-2">
        ...
        <i class="fa-solid fa-clipboard-check"></i>
          <label class="control-label">
            <h4><b>Confirm Returned Books</b></h4>
          </label>
        </div>
        <form action="return_notif.php" method="POST" class="col-lg-5" enctype="multipart/form-data">
...
$message = ("You Succesfully Returned Your Book ");
...
$update_issue_status = mysqli_query($conn, "update tbl_issue set return_date=CURDATE(), status=3 where id='$id'");
