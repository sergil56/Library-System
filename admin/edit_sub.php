...
if (isset($_POST["update"])) {
    ...
    $result = mysqli_query($conn, "update subject set sub_name='$sub_name', status='$status' where id='$ID'");
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="col-lg-12">
                                            ...
                                            <input type="text" class="form-control custom" name="sub_name" value="<?php echo $sub_name; ?>" />
                                        </div>
                                        <div class="mt-4 mb-0">
