...
if (isset($_POST["send"])) {
  ...
  $mail = new PHPMailer(true);
    ...
    <p>As per our records, the book mentioned above is due to be returned by '.$_POST["due_date"].'. 
    
    Please make sure to return the book by this date to avoid any late fees or penalties.
