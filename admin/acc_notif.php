...
if (isset($_POST["send"])) {
  ...
  $mail = new PHPMailer(true);
    ...
    //Content
    $mail->isHTML(true);               
    $mail->Subject = 'Library Notice: Book Request Confirmed - No Reply Necessary'; 
    $mail->Body    = '
    <h4>Dear '.$_POST["name"]. ',</h4>

    <p>I hope this email finds you well. Your book request for the following book has been confirmed from Manjuyod National High School Library.</p>
    ...
    <p>Book is ready for pick up in the Library and make sure to return the book by the due date to avoid any late fees or penalties.
