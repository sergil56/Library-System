  ...
  <div class="wrapper">
    ...
    <div class="main">
      ...
      <main class="content px-3 py-2">
        ...
        <span style="color: red;font:80px;" class="fa-solid fa-circle-xmark"></span>
          <label class="control-label">
            <h4><b>Reject Book Request</b></h4>
          </label>
        </div>
        <form action="rej_notif.php" method="POST" class="col-lg-5" enctype="multipart/form-data">
...
$id = $_GET['id'];
    $update_issue = mysqli_query($conn, "update tbl_issue set status=2 where id='$id'");
    $message = ("Admin Rejected Your Book Request");
