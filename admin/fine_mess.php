      ...
      <main class="content px-3 py-2">
        ...
        <i class="fa-solid fa-clock"></i>
          <label class="control-label">
            <h4><b>Notify For Overdue Books</b></h4>
          </label>
        </div>
        <form action="fine_notif.php" method="POST" class="col-lg-5" enctype="multipart/form-data">
          <table class="table table-bordered bg-light" id="message">
            ...
            <tr>
              <td>
                ...
                <label class="control-label"><b>Penalty</b></label><input type="text" class="form-control" name="fine" value="<?php echo $fine; ?> Pesos" />
              </td>
            </tr>
          </table>
          <input type="submit" name="send" value="Notify Borrower" id="ba" style=" --bs-btn-font-size: .85rem;" class="btn btn-success"><a href="return.php?id=<?php echo $row['id']; ?>"></a>
        </form>
      </main>
    </div>
  </div>
