...
if (isset($_POST["send"])) {
  ...
  $mail = new PHPMailer(true);
    ...
    //Content
    $mail->isHTML(true);               
    $mail->Subject = 'Library Notice: Book Request Rejected - No Reply Necessary'; 
    $mail->Body    = '
    <h4>Dear '.$_POST["name"]. ',</h4>

    <p>We hope this email finds you well. We regret to inform you that your book request has been rejected for some unforeseen circumstances.</p>

          <li><strong>Borrowed Book Title:</strong> '.$_POST["book_name"].'</li>
          <li><strong>Author:</strong> '.$_POST["author"].'</li>
          <li><strong>ISBN number:</strong> '.$_POST["isbnno"].'</li>
          
            
    <p>Once again, thank you for your time and we apologize for this kind of inconvenience. We hope that your future request will be accepted.</p>
